...
f=num/div;
//printf("return num is %d for num %d \n",f,num);
return f;
}
...
// logic to find digit count of largest number
dc=1;
num=largest;
while(num>9)
{
...
//logic to find suitable box ends here
//logic to sort each box starts here
for(y=0;y<=9;y++)
{
int i=0;
...
}//external for ends here
//logic to sort each box ends here
int i=0;
for(y=0;y<=9;y++)
{
while(!isQueueEmpty(&queues[y]))
